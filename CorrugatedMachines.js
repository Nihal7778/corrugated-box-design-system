          ...
          <TableBody>
            {machines.map((machine) => (
              <TableRow key={machine.id}>
                <TableCell>
                  <a href={`/details/${machine.customer_code}`}>{machine.customer_code}</a>
                </TableCell>
                ...
                <TableCell>
                  <IconButton onClick={() => handleEditClick(machine)} color="primary">
                    <EditIcon />
                  </IconButton>
                  <IconButton onClick={() => handleDeleteClick(machine.id)} color="secondary">
                    <DeleteIcon />
                  </IconButton>
                </TableCell>
              </TableRow>
        ...
        <Dialog open={editDialogOpen} onClose={() => setEditDialogOpen(false)}>
          ...
          <DialogContent>
            <TextField
              ...
              label="Customer Code"
              name="customer_code"
              value={editMachine.customer_code}
        ...
        <Dialog open={addDialogOpen} onClose={() => setAddDialogOpen(false)}>
          ...
          <DialogContent>
            <TextField
              ...
              label="Customer Code"
              name="customer_code"
              value={newMachine.customer_code}
