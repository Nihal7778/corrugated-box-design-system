...
function CustomerDetails() {
  ...
  const handleEditSubmit = async () => {
    try {
      const response = await axios.post('http://localhost:5001/customerdetails/update', editCustomer);
      ...
      console.error('Error updating customer detail:', err);
    }
  };
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error adding customer detail:', err);
    }
  };
